...
class BugzillaFields {
    ...
    static final Object[] RESULT_FIELDS = { ASSIGNEE, BLOCKS, COMPONENT, CREATION_TIME, LAST_UPDATED, DEPENDS_ON, SUMMARY, DESCRIPTION,
            ESTIMATED_TIME, FLAGS, HOURS_WORKED, ID, ISSUE_TYPE, PRODUCT, REPORTER, STATUS, TARGET_MILESTONE, TARGET_RELEASE,
            VERSION };
